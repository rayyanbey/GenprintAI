...
type Status = 'pending' | 'shipped' | 'delivered' | 'approved' | 'rejected' | 'paid' | 'unpaid' | 'active' | 'banned' | 'admin' | 'customer' | 'designer' | 'pending_payment' | 'processing' | 'cancelled';
...
const statusConfig: Record<Status, { label: string; className: string }> = {
  ...
  pending_payment: { label: 'Payment Pending', className: 'bg-amber-50 text-amber-700 border-amber-200' },
